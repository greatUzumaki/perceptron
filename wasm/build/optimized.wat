(module
 ...
 (func $assembly/index/toImage~anonymous|0 (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  local.get $0
  i32.const 255
  i32.eq
 )
     ...
     block $~lib/arraybuffer/ArrayBufferView
      block $~lib/string/String
       block $~lib/arraybuffer/ArrayBuffer
        ...
        i32.sub
        i32.load
        br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $folding-inner0 $folding-inner0 $folding-inner0 $folding-inner1 $folding-inner1 $invalid
       end
       return
      end
      return
 ...
 (func $assembly/index/getClearArray (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $assembly/index/toImage~getPixel (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
 ...
 (func $assembly/index/InitWeight (param $0 i32) (result i32)
  (local $1 i64)
  (local $2 i32)
  (local $3 f64)
  (local $4 f64)
 ...
 (func $assembly/index/Correct (param $0 i32) (param $1 i32) (param $2 f32) (param $3 i32) (result i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $export:assembly/index/toImage (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  ...
  block $folding-inner0
   ...
   local.get $2
   local.get $1
   call $assembly/index/getClearArray
   local.tee $6
   i32.store
   global.get $~lib/memory/__stack_pointer
   i32.const 1632
